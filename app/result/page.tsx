...
const ResultPage = () => {
  ...
  const [analysisDataForRedirect, setAnalysisDataForRedirect] = useState<
    string | null
  >(null);
    ...
    <div className="min-h-[92vh] flex flex-col bg-white relative md:pt-[64px] justify-center">
      ...
      <div className="flex-[0.4] md:flex-1 flex flex-col md:flex-row items-center xl:justify-center relative mb-0 md:mb-30 space-y-[-20px] md:space-y-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            >
              <Image
                ...
                height={136}
                decoding="async"
                className="w-[100px] h-[100px] md:w-[136px] md:h-[136px] hover:scale-108 duration-700 ease-in-out relative"
              />
            </div>
        ...
        <div className="absolute top-[-75px] right-7 md:top-[-50px] md:right-8 transition-opacity duration-300 opacity-100">
          ...
          <div className="w-24 h-24 md:w-32 md:h-32 border border-gray-300 bg-gray-100 overflow-hidden flex items-center justify-center relative">
            {previewSrc ? (
              <Image
                src={previewSrc}
          ...
          {analysisError && !isAnalyzing && (
            <p className="text-red-500 text-xs mt-1 max-w-[128px] text-right">
              {analysisError}
            </p>
          )}
        </div>
      ...
      <div className="pt-4 md:pt-0 pb-8 bg-white sticky md:static bottom-30.5 mb-0 md:mb-0">
        <div className="absolute bottom-8 w-full flex justify-between md:px-9 px-13">
          <Link className="relative group" aria-label="Back" href="/">
            <div>
              <div className="relative w-12 h-12 flex items-center justify-center border border-[#1A1B1C] rotate-45 scale-[1] sm:hidden group-hover:scale-105 transition-transform">
                <span className="rotate-[-45deg] text-xs font-semibold sm:hidden text-[#1A1B1C]">
                  BACK
                </span>
              </div>
      ...
      {isAnalyzing && (
        <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-[60] p-4">
      ...
      <style jsx global>{`
        ...
        .animate-bounce_loader {
          animation: bounce_loader 1.4s infinite ease-in-out both;
        }
        .animate-bounce_loader_200 {
          animation: bounce_loader 1.4s infinite 0.2s ease-in-out both;
        }
        .animate-bounce_loader_400 {
          animation: bounce_loader 1.4s infinite 0.4s ease-in-out both;
        }
      `}</style>
