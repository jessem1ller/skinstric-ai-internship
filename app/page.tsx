  ...
  return (
    <div className="max-md:scale-[0.85] max-sm:scale-[0.65] max-sm:origin-center max-sm:p-6">
      <div className="flex flex-col items-center justify-center h-[71dvh] md:fixed md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2">
        <div id="main-heading" className="relative z-10 text-center md:block lg:hidden">
          <div className="relative">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] border-2 border-dotted border-[#A0A4AB] rotate-45 z-[-1] max-md:w-[400px] max-md:h-[400px] max-sm:w-[300px] max-sm:h-[300px]" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] border-2 border-dotted border-[#A0A4AB] rotate-45 z-[-1] max-md:w-[400px] max-md:h-[400px] max-sm:w-[300px] max-sm:h-[300px] scale-[0.85]" />
            <h1
              style={{ ...headingStyle, textAlign: 'center', transform: 'translateX(0)'} as React.CSSProperties}
              className="text-[#1A1B1C] font-inter font-normal tracking-tighter leading-none text-center md:text-[80px] md:leading-[80px] max-sm:text-[50px] max-sm:leading-[50px]"
            >
              Sophisticated
              <br />
        ...
        <div id="main-heading" className="relative z-10 text-center hidden lg:block">
          <h1
        ...
        <div className="z-10 mt-4 lg:hidden">
          <Link href="/testing">
            <button className="relative flex items-center gap-4 hover:scale-105 duration-300">
              ...
              <span className="absolute left-[132px] scale-[0.5] hover:scale-60 duration-300">
                <svg
                  viewBox="0 0 24 24"
                  width="24"
                  height="24"
          ...
          <div className="relative w-full h-full">
            ...
            <Link href="/testing">
              ...
              >
                ...
                <span className="absolute left-[113px] top-[9px] scale-[0.9] cursor-pointer group-hover:scale-105 duration-300">
                   ▶
                </span>
              </button>
            </Link>
